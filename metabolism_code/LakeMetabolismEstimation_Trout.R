...
ts.data$k.gas <- ts.data$k.gas * 0.5
ts.data$k.gas <- ifelse(ts.data$wnd < 5, 0, ts.data$k.gas) # only turning on gas flux if wind is strong enough to mix top layer
