...
gpp_resid = tibble(gpp_resid = summary(lm(mean_gpp ~ mean_tp_load, data = gpp_data))$resid)
r_resid = tibble(r_resid = summary(lm(mean_r ~ mean_tp_load, data = r_data))$resid)
nep_resid = tibble(nep_resid = summary(lm(mean_nep ~ mean_doc_load + mean_tn_load, data = nep_data))$resid)
